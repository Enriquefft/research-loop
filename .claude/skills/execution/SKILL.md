...
Summarize to the user what the session state is:
> "You're in session **[slug]**. Last recorded: [last status line from lab_notebook]. You've run [N] experiments so far. Best metric: [X]."
